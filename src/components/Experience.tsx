...
import FordLogo from "@/assets/Ford_logo.jpg";
...
const education = [
	{
		...
		period: "2025-2026",
		description:
			"Selective interdisciplinary program for top-performing students, focused on developing skills in technology, innovation, and entrepreneurship through hands-on projects and collaboration with leading businesses.",
	},
	{
		icon: Award,
		logo: UPVLogo,
		...
		description: (
			<>
				Relevant coursework: Machine Learning, Computer Vision, 3D Vision, Mobile
				Robotics, Intelligent Agents, Data Structures & Algorithms.
				<br />
...
const experiences = [
	...
	},
	{
		...
		description:
			"Installed and configured digital display systems in educational environments. Conducted site assessments, performed hardware and software testing, and troubleshooting to ensure optimal performance of display units in classrooms and auditoriums.",
	},
];
